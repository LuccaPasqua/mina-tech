...
/** GET /api/admin/inscricoes?status=... */
...
/** GET /api/admin/admins — lista os admins gerenciáveis (sem os super-admins). */
...
/** POST /api/admin/admins  { email } — adiciona um admin gerenciável. */
async function addAdmin(req, res, next) {
  try {
    ...
    // Convida a pessoa por e-mail (cria conta + link p/ definir senha).
    const origin =
      req.headers.origin ||
...
/** DELETE /api/admin/admins/:email — remove um admin gerenciável. */
